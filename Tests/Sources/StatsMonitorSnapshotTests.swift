...
struct StatsMonitorSnapshotTests {
    ...
    func cpuDetailPanelScreenshot() {
        ...
        monitor.topCPUProcesses = [
            ProcInfo(pid: 201, name: "Xcode", cpuPercent: 48.2, memoryBytes: 1_610_612_736),
            ProcInfo(pid: 202, name: "StatsMonitor", cpuPercent: 12.7, memoryBytes: 92_274_688),
            ProcInfo(pid: 203, name: "WindowServer", cpuPercent: 7.4, memoryBytes: 421_527_552),
        ]
